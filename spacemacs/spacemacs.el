  ...
  (setq-default
   ...
   '(
     ...
     (python :variables
             ...
             python-enable-tools '(uv pipenv pip)
             )
     restructuredtext
     semantic
     (shell :variables
...
(defun dotspacemacs/init ()
  ...
  (setq-default
   ...
   ;; in emacs 27.
   ;; (default (* 1024 1024))
   dotspacemacs-read-process-output-max (* 1024 (* 4 1024))
   ...
   dotspacemacs-background-transparency 70
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(lsp-io-messages-max 50000)
   '(lsp-keep-workspace-alive nil)
   '(lsp-progress-spinner-type 'progress-bar-filled)
   '(lsp-restart 'auto-restart)
   '(lsp-signature-doc-lines 60)
   '(lsp-treemacs-symbols-space-between-root-nodes t)
   ...
   '(nerd-icons--cache-limit 8192)
   '(nerd-icons-font-family "FiraCode Nerd Font Mono")
   '(package-selected-packages
     '(2048-game ace-link aggressive-indent all-the-icons auctex-latexmk auto-compile
                 auto-highlight-symbol auto-yasnippet browse-at-remote
                 centaur-tabs centered-cursor-mode clean-aindent-mode cmake-mode
                 code-cells code-review color-identifiers-mode column-enforce-mode
                 company-auctex company-box company-c-headers company-math
                 company-quickhelp company-reftex company-shell company-web
                 compleseus-spacemacs-help consult-lsp consult-yasnippet
                 cpp-auto-include cython-mode dactyl-mode dap-mode define-word
                 devdocs diff-hl diminish dired-quick-sort disable-mouse disaster
                 dotenv-mode drag-stuff dtrt-indent dumb-jump eat edit-indirect
                 ...
                 evil-args evil-cleverparens evil-collection evil-commentary
                 evil-easymotion evil-escape evil-evilified-state evil-exchange
                 evil-goggles evil-iedit-state evil-indent-plus evil-lion
                 evil-lisp-state evil-matchit evil-numbers evil-org evil-surround
                 ...
                 gnuplot golden-ratio google-c-style google-translate helm-make
                 hide-comnt highlight-indentation highlight-numbers
                 highlight-parentheses holy-mode hungry-delete hybrid-mode
                 impatient-mode indent-guide info+ insert-shebang inspector
                 journalctl-mode json-mode json-navigator json-reformat link-hint
                 live-py-mode lorem-ipsum lsp-latex lsp-origami lsp-ui lua-mode
                 macrostep magit-delta magit-todos marginalia markdown-toc
                 meson-mode multi-line multi-term multi-vterm mwim nameless
                 neotree nerd-icons nyan-mode open-junk-file orderless
                 ...
                 password-generator persistent-scratch persp-mode pip-requirements
                 popwin prettier-js pug-mode py-isort pydoc pyenv-mode pylookup
                 python-pytest pyvenv quickrun rainbow-delimiters
                 ...
                 string-edit-at-point string-inflection sudoku symbol-overlay
                 symon systemd tagedit term-cursor terminal-here toc-org toml-mode
                 tree-sitter-langs typit undo-tree unfill unkillable-scratch uv
                 vertico vim-empty-lines-mode vimrc-mode volatile-highlights
   ...
   '(projectile-globally-ignored-directories
     '(".idea" ".vscode" ".ensime_cache" ".eunit" ".git" ".hg" ".fslckout" "_FOSSIL_"
       ...
       ".sl" ".jj" ".ropeproject" ".mypy_cache" "build" "__pycache__"))
   '(projectile-install-use-comint-mode t)
   '(projectile-mode t nil (projectile))
   '(projectile-package-use-comint-mode t)
   '(projectile-project-root-files
     '("Package.swift" "build.zig.zon" "dune-project" "Project.toml" "elm.json"
       "pubspec.yaml" "info.rkt" "Cargo.toml" "stack.yaml" "DESCRIPTION" "Eldev"
       "Eask" "Cask" "shard.yml" "Gemfile" "deps.edn" "build.boot" "project.clj"
       "build.mill" "build.sc" "build.sbt" "application.yml" "gradlew"
       "build.gradle" "pom.xml" "pyproject.toml" "poetry.lock" "Pipfile" "tox.ini"
       ...
       "WORKSPACE" "flake.nix" "default.nix" "meson.build" "SConstruct"
       "xmake.lua" "?*.nimble" "?*.sln" "?*.fsproj" "?*.csproj" "GTAGS" "TAGS"
       "configure.ac" "configure.in" "cscope.out" ".clangd" ".luarc.json"))

...
yay.opt.redownload = "no" ---@type "no"|"yes"|"all"
...
yay.opt.sort_by = "" ---@type "votes"|"popularity"|"name"|"base"|"submitted"|"modified"|""
yay.opt.search_by = "name-desc" ---@type "name"|"name-desc"|"maintainer"|"submitter"|"depends"|"makedepends"|"optdepends"|"checkdepends"|"provides"|"conflicts"|"replaces"|"groups"|"keywords"|"comaintainers"
yay.opt.git_flags = "" -- Extra flags passed to git.
yay.opt.remove_make = "askyes" ---@type "no"|"yes"|"ask"|"askyes"
yay.opt.sudo_bin = "sudo" -- Privilege elevation command.
yay.opt.sudo_flags = "" -- Extra flags passed to the sudo command.
yay.opt.rebuild = "no" ---@type "no"|"yes"|"tree"|"all".
yay.opt.answer_clean = "" ---@type ""|"All"|"None"|"Installed"|"NotInstalled" (also accepts menu syntax: ranges, ^n, "abort").
yay.opt.answer_diff = "" ---@type ""|"All"|"None"|"Installed"|"NotInstalled" (also accepts menu syntax: ranges, ^n, "abort").
yay.opt.answer_edit = "" ---@type ""|"All"|"None"|"Installed"|"NotInstalled" (also accepts menu syntax: ranges, ^n, "abort").
...
yay.opt.diff_menu = false -- Show diff menu before building.
...
yay.opt.use_ask = true -- Use pacman's --ask to auto-confirm known conflicts.
yay.opt.batch_install = false -- Queue AUR package installs instead of installing each package immediately.
yay.opt.single_line_results = true -- Use single-line search result format.
